...
class AddWorkoutPageState extends State<AddWorkoutPage> {
  ...
  List<ExerciseCard> exercises = [new ExerciseCard(), new ExerciseCard(), new ExerciseCard()];
  int dropdownValue = 1;
                    ...
                    children: [
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Padding(padding: EdgeInsets.only(top: 10.0, bottom: 10.0), child: this.exercises.elementAt(index));
                          }),
                      Center(
                          child: TextButton(
                              child: Text('Add Exercise'), onPressed: () {
                                setState(() {
                                  this.exercises.add(new ExerciseCard());
                                });
                                
                              })),
                      Center(
                          child: TextButton(
                              child: Text('Create Workout'), onPressed: () {
